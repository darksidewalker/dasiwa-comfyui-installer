...
class SageInstaller:
    ...
    def plan_windows_torch(cls, python_display, cuda_target):
        ...
        _FALLBACK = {
            # PyTorch 2.12 publishes CUDA 13.0 wheels, but CUDA 12.8 tops out at
            # older stable releases. Pin public versions and let the CUDA index
            # provide the local +cuXXX wheel build.
            ("3.12", "12.8"): "2.10.0",
    ...
    def _source_build(cls, venv_env, comfy_path, config_urls, python_exe):
        ...
        # Resolve nvcc/host-compiler version mismatch (e.g. GCC 16 on CachyOS
